...
// Adding hover sections
document.getElementById('tree-array-button').addEventListener('mouseover', () => {
  document.querySelector('#hover-section').innerHTML = "Visualize Binary Tree and its corresponding Array representation.";
});
document.getElementById('tree-array-button').addEventListener('mouseout', () => {
  document.querySelector('#hover-section').innerHTML = "";
});

document.getElementById('heapify-button').addEventListener('mouseover', () => {
  document.querySelector('#hover-section').innerHTML = "Convert the array into a Max-Heap and visualize the Binary Tree.";
});
document.getElementById('heapify-button').addEventListener('mouseout', () => {
  document.querySelector('#hover-section').innerHTML = "";
});

document.getElementById('bst-button').addEventListener('mouseover', () => {
  document.querySelector('#hover-section').innerHTML = "Sort the input data and arrange it into a Binary Search Tree.";
});
document.getElementById('bst-button').addEventListener('mouseout', () => {
  document.querySelector('#hover-section').innerHTML = "";
});
